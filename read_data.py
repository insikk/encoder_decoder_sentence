...
def read_data(config, data_type, word2vec_ref, data_filter=None):
...
def update_config(config, data_sets):
    ...
    config.total_word_vocab_size = len(data_sets[0].shared['new_emb_mat']) + len(data_sets[0].shared['word2idx'])
