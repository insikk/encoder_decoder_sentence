...
if __name__=="__main__":
    dir_name = "../snli_1.0/"
    train=[l.strip().split('\t') for l in open(dir_name+'snli_1.0_train.txt')][:20000]
    dev=[l.strip().split('\t') for l in open(dir_name+'snli_1.0_dev.txt')]
    test=[l.strip().split('\t') for l in open(dir_name+'snli_1.0_test.txt')]
